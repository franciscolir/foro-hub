...
public class SecurityFilter extends OncePerRequestFilter {
    ...
    private String recuperarToken(HttpServletRequest request) {
        var authorizationHeader = request.getHeader("Authorization");//recibe el header de la consulta
        if (authorizationHeader != null) {
            return authorizationHeader.replace("Bearer ", "");//remplaza el bearer por vacio
        }
